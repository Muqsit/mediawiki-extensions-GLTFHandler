...
These fixtures come from [KhronosGroup/glTF-Sample-Assets](https://github.com/KhronosGroup/glTF-Sample-Assets/tree/90d7ede14c7e280af263824604b427a1ca02cb66/Models).

| Model | Author | License |
| --- | --- | --- |
| AnimatedMorphCube | Microsoft | CC0-1.0 |
| BoxAnimated | Cesium | CC-BY-4.0 |
| BoxInterleaved | Cesium | CC-BY-4.0 |
| BoxTextured | Cesium | CC-BY-4.0; includes a Cesium trademark used by permission |
| CesiumMilkTruck | Cesium | CC-BY-4.0; includes a Cesium trademark used by permission |
